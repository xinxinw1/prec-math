...
(function (window, undefined){
  ...
  function getA(z){
    return z.substring(1, z.indexOf(","));
  }
  
  function getB(z){
    return z.substring(z.indexOf(",")+1, z.length-1);
  }
  ...
  function gt(a, b){ // is (a > b) ?
    ...
    error("Error: gt: Something strange happened");
  }
  ...
  function lt(a, b){ // is (a < b) ?
    ...
    error("Error: lt: Something strange happened");
  }
  ...
  function ge(a, b){ // is (a >= b) ?
    ...
    error("Error: ge: Something strange happened");
  }
  ...
  function le(a, b){ // is (a <= b) ?
    ...
    error("Error: le: Something strange happened");
  }
  ...
  */
  ...
  function acotrTaylor(a, nprec){
    ...
    for (var i = 3; true; i += 2, sign = !sign){
      ...
      func1 = divr("1", multr(String(i), pow), nprec+2);
  ...
  // @param String a
  // @param Number n
  function acotrTrans(a, n, nprec){
    for (var i = n; i >= 1; i--){
      a = addr(a, sqrtr(addr("1", multr(a, a)), nprec+i+2), nprec+i+2);
    }
    
    return roundr(a, nprec);
  }
  
  function acotrTaylorTrans(a, n, nprec){
    a = acotrTrans(a, n, nprec+2);
    return multr(powrExact("2", n), acotrTaylor(a, nprec+1), nprec); // 16 = 2^4
  }
  ...
  window.R = {
    ...
    genContFracNums: genContFracNums,
  ...
  //alert(mDotLeft(sqrtrCont("2342342138", 999), 1));
  //alert(sqrtr("234234235435235325", 100));
  //alert(isDiffZero("-253423621415.0127350928423492806541", "253423621415.5127350928423492806540", 0));
  //alert(sqrtrNewton2("234234235435", 100));
  //alert(isDiffZero3("10.9", "5.4", -1));
  //alert(isDiffZero3("10.07", "9.56", 0));
  //alert(sqrtrNewton2("234234235435", 100));
  //alert(isqrtr2("6"));
  //alert(roundr("2217119.999999999986868995423876", 2));
  //alert(sqrtrNewton(multr("1.24232492", mDotLeft("1", 350)), 350));
