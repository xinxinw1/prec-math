...
(function (win, udf){
  ...
  */
  ...
  //al(atanTaylorTrans("0.2", 100));
  //al(atanTaylor("0.2", 100));
  
  //al(exp("-500", 1000));
  //al(exp2("-500", 1000));
  
  //al(exp("300.123578290384092384", 100));
  //al(exp2("300.123578290384092384", 100));
  
  //al(exp("3", 1000));
  //al(exp2("3", 1000));
  
  //al(sinTaylorFrac2("50", 100))
  
  //al(expTaylorTerms2("100", 100));
  
  //al(powDec(pi(1000), "254", 100));
  //al(powDec3(pi(1000), "254", 100));
